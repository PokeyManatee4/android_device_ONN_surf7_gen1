...
all:
  cd $HOME/twrp/ && git clone https://github.com/PokeyManatee4/android_device_ONN_surf7_gen1.git device/ONN/REL
  ...
  cp $HOME/twrp/out/target/product/REL/recovery.img $HOME/twrp/TWRP-$version-REL-$(date +"%Y%m%d")-Unofficial.img
  cd $HOME/twrp/
