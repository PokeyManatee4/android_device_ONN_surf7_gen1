...
config:
  ...
  tar --zstd -xf twrp.tzst --directory ~ && rm twrp.tzst
  ...
  tar --zstd -xf MinimalOmniRecovery-twrp-*.*-norepo-2020*.tzst.aa --directory ~/twrp/ && rm MinimalOmniRecovery*.tzst.*
  
all:
  cd ~ && git clone https://github.com/PokeyManatee4/android_device_ONN_surf7_gen1.git device/ONN/REL
